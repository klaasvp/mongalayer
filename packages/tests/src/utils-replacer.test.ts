...
import { IterateCallback, iteratePrimitives } from '../../server/src/utils/replacer.js';

describe('iteratePrimitives', () => {
    test('should iterate over string primitives in an object', () => {
        const obj = { a: 'hello', b: 123, c: true };
        const callback = jest.fn<IterateCallback>((key, value, replace) => {
    ...
    test('should handle empty objects and arrays', () => {
        const obj = {};
        const arr: any[] = [];
        const callback = jest.fn<IterateCallback>();
