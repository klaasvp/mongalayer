...
:::tabs
::::tabs-item{label="AWS Lambda (JSON)"}
```ts [server/index.ts]
import { APIGatewayProxyHandlerV2WithJWTAuthorizer } from "aws-lambda";
import { layer } from "./mongalayer.js";
import { ServerError } from "@mongalayer/server";
...
export const handler: APIGatewayProxyHandlerV2WithJWTAuthorizer = async (event, context) => {
    try {
        ...
        const result = await layer.executeJSON(
            event.body!,  // The request body — Includes the action and payload
...
```
::::
::::tabs-item{label="AWS Lambda (routed)"}
```ts [server/index.ts]
import { APIGatewayProxyHandlerV2WithJWTAuthorizer } from "aws-lambda";
import { layer } from "./mongalayer.js";
